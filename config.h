...
char devname[] = "/dev/input/by-id/usb-Atmel_Atmel_maXTouch_Digitizer_H19R065307-event-if01";
...
/*minimum length required for something to be a swipe, pinch, tap*/
double swipetolerance = 0.01;
double pinchtolerance = 0.001;
double taptolerance = 0.001;
